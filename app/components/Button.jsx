...
export const Button = forwardRef(
  (
    ...
    const baseButtonClasses =
      'inline-block rounded-full text-center py-3 px-6';
    ...
    const variants = {
      ...
      secondary: `${baseButtonClasses} border border-primary bg-contrast text-primary rounded-full font-tertiary common-btn-line-height fs-17 fw-500 secondary-btn`,

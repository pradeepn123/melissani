...
function CartLines({layout = 'drawer', lines: cartLines}) {
  ...
  return (
    ...
    >
      ...
      {filterClubLineItems && <div className="cart-shipment-info">
  ...
  return <li className="flex gap-6">
      ...
      <div className="flex justify-between items-center flex-grow">
        <div className="grid gap-2">
          ...
          <div className="flex items-center cart-filter-club-icons">
            <button className="flex items-center" onClick={context.openFilterClubBottomModal}>

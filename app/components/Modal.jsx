...
import {IconClose, Link, RequestContext} from '~/components';
...
export function Modal({children, cancelLink, classname}) {
  ...
  const props = {to: cancelLink}
  if (context.labReportInformation) {
    props.onClick = () => context.setLabReportInformation(false)
  }

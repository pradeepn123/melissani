        ...
        <div className="fixed inset-0">
          <div className="absolute inset-0 overflow-hidden">
            ...
            >
              ...
              >
                <Dialog.Panel className={`drawer-dialog-panel w-screen max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl text-left align-middle transition-all transform shadow-xl h-screen-dynamic bg-contrast ${isCartDrawer ? 'cart-drawer-dialog-panel' : ''}`}>
